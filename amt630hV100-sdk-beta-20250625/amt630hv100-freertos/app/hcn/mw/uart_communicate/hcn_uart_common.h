...
#define UART_MCU_CMD_SHUTDOWN (0x8004)
#define UART_MCU_CMD_ACK_SHUTDOWN (0x0004)

#define UART_MCU_CMD_REQ_VER (0x8005)
#define UART_MCU_CMD_CHECKSELF (0x8006)
#define UART_MCU_CMD_CTRL_SYSTEM_MODE (0x8007)
#define UART_MCU_CMD_CLAER_SUB_MILEAGE (0x8008)

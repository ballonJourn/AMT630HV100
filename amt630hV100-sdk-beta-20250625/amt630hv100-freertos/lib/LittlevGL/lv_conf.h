...
#if LCD_ROTATE_ANGLE == LCD_ROTATE_ANGLE_0 || LCD_ROTATE_ANGLE == LCD_ROTATE_ANGLE_180
#define LV_HOR_RES_MAX          (LCD_WIDTH)
#define LV_VER_RES_MAX          (LCD_HEIGHT)
#elif LCD_ROTATE_ANGLE == LCD_ROTATE_ANGLE_90 || LCD_ROTATE_ANGLE == LCD_ROTATE_ANGLE_270
#define LV_HOR_RES_MAX          (LCD_HEIGHT)
#define LV_VER_RES_MAX          (LCD_WIDTH)
#endif
...
#define LV_USE_GPU_ARK_BLEND2D	0
...
#endif
#define LV_USE_ROMFILE_FILESYSTEM	1
#if LV_USE_ROMFILE_FILESYSTEM
#include <stdio.h>
#include <romfile.h>
#endif
...
#define LV_TICK_CUSTOM_INCLUDE_MORE  "task.h"      /*Another header for the sys time function*/
...
#define LV_THEME_DEFAULT_FONT_NORMAL        &myFont24//&lv_font_montserrat_24
#define LV_THEME_DEFAULT_FONT_SUBTITLE      &myFont26//&lv_font_montserrat_26
...
/*Dashboard (dependencies: lv_img) */
#define LV_USE_OPENVG	1

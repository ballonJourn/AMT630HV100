...
typedef ret_t(*vgcanvas_clip_dirty_rects_t)(vgcanvas_t* vg, const dirty_rects_t* dirty_rects);
#endif
...
// 20211230 增加VG风格的线性渐变色
typedef ret_t (*vgcanvas_set_stroke_vg_linear_gradient_t)(vgcanvas_t* vg, float_t sx, float_t sy,
                                                       float_t ex, float_t ey, 
                                                       float_t * ramp_stops, int32_t ramp_stops_count);
...
typedef struct _vgcanvas_vtable_t {
...
#ifdef DIRTY_RECTS_CLIP_SUPPORT
  vgcanvas_clip_dirty_rects_t clip_dirty_rects;
#endif
  ...
  // 20211230 增加VG风格的线性渐变色
  vgcanvas_set_stroke_vg_linear_gradient_t set_stroke_vg_linear_gradient;
...
#ifdef DIRTY_RECTS_CLIP_SUPPORT
/**
* @_method vgcanvas_clip_rectdirty_s
* 矩形裁剪。
*
* @annotation ["scriptable"]
* @param {vgcanvas_t*} vg vgcanvas对象。
* @param {dirty_rects_t*} dirty_rects。
*
* @return {ret_t} 返回RET_OK表示成功，否则表示失败。
*/
ret_t vgcanvas_clip_dirty_rects(vgcanvas_t* vg, const dirty_rects_t* dirty_rects);
#endif
...
// 20211230 增加VG风格的线性渐变色
/**
 * @method vgcanvas_set_stroke_vg_linear_gradient
 * 设置线条颜色为线性渐变色。
 *
 * @param {vgcanvas_t*} vg vgcanvas对象。
 * @param {float_t} sx start x
 ...
 * @param {float_t} ex end x
 * @param {float_t} ey end y
 * @param {float_t *} ramp_stops VG格式的rampStops描述
 * @param {int32_t} ramp_stops_count rampStops浮点数组的个数。
 *
 * @return {ret_t} 返回RET_OK表示成功，否则表示失败。
 */
ret_t vgcanvas_set_stroke_vg_linear_gradient (vgcanvas_t* vg, float_t sx, float_t sy, float_t ex,
                                          float_t ey, float_t * ramp_stops, int32_t ramp_stops_count);
